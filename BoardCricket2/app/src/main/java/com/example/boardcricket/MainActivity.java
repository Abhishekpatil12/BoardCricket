...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String path1 = "android.resource://"+getPackageName()+"/raw/cricket";
    ...
    private void rollDice() throws InterruptedException {
        ...
        System.out.println("Check value : "+check123);

        int checkint = Integer.parseInt(check123);

        if(flag==0)
        {
            DecimalFormat decimalFormat = new DecimalFormat("0.0");
            int score = Integer.parseInt((String) txtrun1.getText());
            int score2 = Integer.parseInt((String) txtrun2.getText());
            ...
            for(int a=prevscore; a<score ; a++) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        System.out.println("score aus "+score10);

                        if(score10!=0) {


                            String setstr1 = "imageView" + score10;
                            int res = getResources().getIdentifier(setstr1, "id", getPackageName());
                            imgset = findViewById(res);
            ...
            t.schedule(new TimerTask() {
                ...
                @Override
                public void run() {
                    int prevscore = Integer.parseInt((String) txtrun1.getText());
                    int sc = prevscore + i;

                    for(int j=prevscore;j<sc;j++) {
                        int y=1000;

                        int res1 = getResources().getIdentifier("imageView"+j, "id", getPackageName());
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                //imgset.setImageResource(R.drawable.virat);
                            }
                        });
            ...
            t1.schedule(new TimerTask() {
                @Override
                public void run() {
                    int res1 = getResources().getIdentifier("imageView92", "id", getPackageName());
                    imgset = findViewById(res1);
                    imgset.setImageResource(R.drawable.virat);
                }
            }, 3000);
            ...
            t2.schedule(new TimerTask() {
                @Override
                public void run() {
                    int res1 = getResources().getIdentifier("imageView93", "id", getPackageName());
                    imgset = findViewById(res1);
                    imgset.setImageResource(R.drawable.virat);
                }
            }, 5000);
        ...
        else
        {
            ...
            int score2 = Integer.parseInt((String) txtrun1.getText());
            ...
            for(int a=prevscore; a<score; a++) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        int score10 = Integer.parseInt((String) txtrun1.getText());
            ...
            int res1 = getResources().getIdentifier(setstr,"id",getPackageName());
            //int res1 = getResources().getIdentifier(strprev,"drawable",getPackageName());
            //imgset = findViewById(res1);
            //imgset.setImageResource(resplayer2);
